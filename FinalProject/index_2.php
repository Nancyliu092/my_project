  ...
  <div class="nav1">
    <ul class='nav-bar'>
        ...
        <div class="menu" id="main-menu">
            <!-- 搜尋表單開始 -->
        <li>
          <form id="search-form" action="search_after_login.php" method="GET">
...
<div id="search-results" class="hidden">
  ...
  <!-- 搜尋表單開始 (僅在小螢幕顯示) -->
  <form id="search-form-modal" class="search-form search-form-mobile" action="search_after_login.php" method="GET">
  ...
  <div id="nav-close"><i class="fas fa-times"></i></div>
    ...
    <section>
      <div class="content">
        ...
        <div id="container" onclick="window.location.href='Finalproject1105-4th/menu_after_login.php';" style="cursor: pointer;">
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            ...
            <div class="overlay">
              ...
              <p>
              Savor a vibrant Aussie brunch with avocado, hash browns, eggs, and tropical fruits. Perfect for a sunny, relaxed morning down under.
              </p>
              <div class="ratings">
                <div class="stars">
          ...
          <div class="swiper-slide">
            <img src="1 (2).png"/>
            <div class="overlay">
              <h1>Classic Hong Kong-Style</h1>
              <p>
              Taste Hong Kong's brunch fusion of noodles, egg toast, sausages, and milk tea. A lively start to the day with bold flavors.
              </p>
              <div class="ratings">
                <div class="stars">
                  <ion-icon class="star" name="star"></ion-icon>
          ...
          <div class="swiper-slide">
            <img src="1 (3).png" />
            <div class="overlay">
              <h1>Luxurious Continental Brunch</h1>
              <p>
              Enjoy a continental spread of eggs, beans, smoked salmon, and fresh toast. Paired with iced coffee for a touch of indulgence.
              </p>
              <div class="ratings">
                <div class="stars">
                  <ion-icon class="star" name="star"></ion-icon>
          ...
          <div class="swiper-slide">
            <img src="1 (4).png" />
            <div class="overlay">
              <h1>Cozy Corner Brunch</h1>
              <p>
              A delightful mix of scrambled eggs, bacon rolls, and croissant. Ideal for a calm, sunny morning paired with coffee.
              </p>
              <div class="ratings">
                <div class="stars">
                  <ion-icon class="star" name="star"></ion-icon>
...
<div style="background-color: #FF8C00; color: #ffffff; text-align: center; width: 100%; padding-top: 40px; padding-bottom: 40px;">
  ...
  <div class="footer-bottom" style="text-align: center;">
    ...
    <script src="javascript1_after_login.js"></script>
